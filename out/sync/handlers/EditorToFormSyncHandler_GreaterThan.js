...
exports.EditorToFormSyncHandler_GreaterThan = void 0;
const vscode = __importStar(require("vscode"));
const BaseSyncHandler_1 = require("../core/BaseSyncHandler");
class EditorToFormSyncHandler_GreaterThan extends BaseSyncHandler_1.BaseSyncHandler {
    constructor(options) {
        super(options);
    }
    canHandle(event) {
...
exports.EditorToFormSyncHandler_GreaterThan = EditorToFormSyncHandler_GreaterThan;
//# sourceMappingURL=EditorToFormSyncHandler_GreaterThan.js.map
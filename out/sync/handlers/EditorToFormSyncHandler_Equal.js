...
exports.EditorToFormSyncHandler_Equal = void 0;
const vscode = __importStar(require("vscode"));
const BaseSyncHandler_1 = require("../core/BaseSyncHandler");
class EditorToFormSyncHandler_Equal extends BaseSyncHandler_1.BaseSyncHandler {
    constructor(options) {
        super(options);
    }
    canHandle(event) {
...
exports.EditorToFormSyncHandler_Equal = EditorToFormSyncHandler_Equal;
//# sourceMappingURL=EditorToFormSyncHandler_Equal.js.map